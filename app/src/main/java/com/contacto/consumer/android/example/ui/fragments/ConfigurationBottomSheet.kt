...
import com.contacto.consumer.android.example.databinding.ConfigurationBottomSheetBinding
import com.contacto.consumer.android.example.ui.storage.UserPref
    ...
    private fun initUi() {
        ...
        binding.tvDone.setOnClickListener {
            ...
            if(appId.isNotEmpty() && appKey.isNotEmpty()) {
                UserPref.savePref(requireContext(), appId, appKey)
                dismiss()
            }
        }
